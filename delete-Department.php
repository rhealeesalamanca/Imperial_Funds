...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    $sql = "DELETE FROM tblDepartment WHERE DepartmentId = ?";
    ...
    if($stmt = $mysqli->prepare($sql)){
        ...
        // Set parameters
        $param_DepartmentId = trim($_POST["id"]);
                        ...
                        <h3 style="color:#3b72f9;" class="pt-4">DELETE RECORD</h3>
                            ...
                            <div class="alert alert-danger">
                                ...
                                <p>
                                    ...
                                    <a href="manage-Department.php" class="btn btn-outline-secondary ml-2">No</a>
                                </p>
                            </div>
                            </form>
                        </div>
