            ...
            <div class="row g-0">
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <div class="d-flex align-items-center mb-3 pb-1">
                    <span class="h2 fw-bold mb-0 text-white">Admin Sign Up</span>
                </div>
                <h5 class="fw-normal mb-3 pb-3 text-white" style="letter-spacing: 1px;">Fill this form to create an account.</h5>
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <p  class="mb-5 pb-lg-2" style="color: #6bedaf;">Already have an account? <a href="admin-login.php">Login here</a>.</p>
